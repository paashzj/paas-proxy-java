...
java $JAVA_OPT $JVM_OPT -Dlog4j.configurationFile=conf/log4j2.yaml -classpath $PROXY_HOME/lib/*:$PROXY_HOME/paas-proxy.jar:$PROXY_HOME/conf/*  com.github.shoothzj.paas.proxy.Main >>$PROXY_HOME/logs/stdout.log 2>>$PROXY_HOME/logs/stderr.log
