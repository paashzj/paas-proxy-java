...
java $JAVA_OPT $JVM_OPT -Dlog4j.configurationFile=conf/log4j2.yaml -classpath /opt/sh/lib/*:/opt/sh/paas-proxy.jar:/opt/sh/conf/*  com.github.shoothzj.paas.proxy.Main >>/opt/sh/logs/stdout.log 2>>/opt/sh/logs/stderr.log
